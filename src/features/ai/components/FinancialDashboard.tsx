        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm overflow-hidden">
            <div className="p-4 border-b dark:border-slate-800 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 className="text-xs font-black text-gray-800 dark:text-white">التحليل المالي</h3>
            ...
            <div className="grid grid-cols-2 border-b dark:border-slate-800">
                <div className="p-3 border-l dark:border-slate-800">
                    <p className="text-[8px] font-black text-emerald-500 uppercase mb-2 flex items-center gap-1"><TrendingUp size={9} /> إيرادات حقيقية</p>
                ...
                <div className="p-3">
                    <p className="text-[8px] font-black text-rose-500 uppercase mb-2 flex items-center gap-1"><TrendingDown size={9} /> مصروفات حقيقية</p>
            ...
            {analysis.length > 0 && (
                <div className="p-4">
                    <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <span className="text-[8px] font-black text-emerald-600">تحليل مبني على بيانات النظام الحية</span>
