        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 shadow-sm overflow-hidden">
            <div className="p-4 border-b dark:border-slate-800 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 className="text-xs font-bold text-gray-800 dark:text-white">المستشار الاستراتيجي</h3>
                ...
                <button onClick={getAdvice} disabled={isLoading}
                    className="px-3 py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl text-[10px] font-bold hover:opacity-90 transition-all shadow-lg shadow-amber-500/20 disabled:opacity-50 flex items-center gap-1"
                >
                        ...
                        <div className="space-y-2">
                            {advice.map((tip, i) => (
                                <div key={i} className="flex items-start gap-2 p-2.5 bg-amber-50/50 dark:bg-amber-950/10 rounded-xl border border-amber-100/30 dark:border-amber-900/10">
                                    <span className="text-[10px] font-bold text-amber-500 bg-amber-100 dark:bg-amber-900/30 w-5 h-5 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">{i + 1}</span>
