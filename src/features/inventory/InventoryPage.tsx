...
import { Plus, Box, LayoutGrid, List, Database, ArrowLeftRight, History, Warehouse, FileSearch, Layers, Upload, Sparkles, TrendingUp, Activity, Car, Archive } from 'lucide-react';
