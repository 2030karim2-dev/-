                ...
                <div className="flex-1 overflow-auto custom-scrollbar">
                    <table className="w-full border-collapse border-spacing-0">
                        <thead className="bg-gray-100 dark:bg-slate-800 sticky top-0 z-10 shadow-sm">
                            <tr className="text-[8px] font-bold text-gray-500 uppercase tracking-tighter">
                        ...
                        <tbody className="divide-y dark:divide-slate-800">
                            {isLoading ? (
                                <tr><td colSpan={7} className="p-10 text-center animate-pulse text-[10px] font-bold text-gray-400">جاري مسح قاعدة البيانات...</td></tr>
                            ) : products.length === 0 ? (
                                ...
                                products.map((p, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="border border-gray-100 dark:border-slate-800 p-1.5 text-[10px] font-bold">{p.name}</td>
