    ...
    return (
        <div className="flex flex-col h-full bg-[#f8fafc] dark:bg-slate-950">
            <MicroHeader
                ...
                actions={
                    <div className="flex items-center gap-2 text-[9px] font-bold text-violet-600 bg-violet-100 dark:bg-violet-900/30 dark:text-violet-400 px-3 py-1.5 rounded-full">
                        <Sparkles size={10} />
                        AI Command Center
                    </div>
                }
