    ...
    const handleExportExcel = () => {
        ...
        exportReturnsToExcel({
            ...
            returns: processedReturns.map((r: any) => ({
                ...
                customerName: '',
                supplierName: r.party?.name || 'مورد نقدي',
                referenceInvoice: '',
                returnReason: '',
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                    ...
                    <p className="text-2xl font-black text-blue-700 dark:text-blue-300">
                        {stats?.returnCount ? (stats.totalReturns / stats.returnCount).toFixed(2) : '0.00'}
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-3">
                    ...
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            placeholder="بحث بالمورد، رقم الفاتورة، سبب الإرجاع..."
