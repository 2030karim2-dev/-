            ...
            <div ref={ref} className="max-w-4xl mx-auto space-y-8 bg-white dark:bg-slate-900 p-8 text-right font-cairo" dir="rtl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-gray-50/50 dark:bg-slate-800/30 p-6 rounded-3xl border border-gray-100 dark:border-slate-800">
                        <div className="flex items-center gap-2 text-gray-400 dark:text-slate-500 mb-4 text-[10px] font-bold uppercase tracking-widest border-b border-gray-200 dark:border-slate-700 pb-2">
                            <User size={14} />
                    ...
                    <div className="bg-gray-50/50 dark:bg-slate-800/30 p-6 rounded-3xl border border-gray-100 dark:border-slate-800 flex flex-col justify-between">
                        <div className="flex items-center gap-2 text-gray-400 dark:text-slate-500 mb-2 text-[10px] font-bold uppercase tracking-widest border-b border-gray-200 dark:border-slate-700 pb-2">
                            <Calendar size={14} />
                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-2 px-1 text-gray-800 dark:text-slate-100 border-b-2 border-blue-600 w-fit pb-1">
                        ...
                        <h3 className="font-bold uppercase tracking-tight text-sm">البضائع والأصناف</h3>
                    </div>

                    <div className="border border-gray-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
                        <table className="w-full text-sm text-right">
                            <thead className="bg-gray-50 dark:bg-slate-800/80 text-gray-500 dark:text-slate-400 font-bold uppercase text-[10px] tracking-wider border-b border-gray-200 dark:border-slate-700">
                                <tr>
                                ...
                                {invoice.invoice_items?.map((item: any, index: number) => (
                                    <tr key={item.id} className="hover:bg-blue-50/30 dark:hover:bg-slate-800/30 transition-colors">
                                        ...
                                        <td dir="ltr" className="p-4 text-center">
                                            <span className="font-bold text-gray-700 dark:text-slate-200 bg-gray-100 dark:bg-slate-800 px-2 py-1 rounded-lg">
                                        ...
                                        <td dir="ltr" className="p-4 text-left font-mono font-bold text-blue-600 dark:text-blue-400">{formatCurrency(item.total)}</td>
                                    </tr>
                                ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6 border-t border-gray-100 dark:border-slate-800 mt-8">
                    ...
                    <div className="md:col-span-2">
                        <div className="bg-amber-50 dark:bg-amber-900/10 p-5 rounded-2xl border border-amber-100 dark:border-amber-900/30 h-full">
                            <h4 className="font-bold text-amber-800 dark:text-amber-500 text-[10px] uppercase mb-2 tracking-widest flex items-center gap-2">
                                <FileText size={12} />
                                ملاحظات
                            </h4>
                        ...
                        <div className="p-0.5 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 shadow-xl shadow-blue-500/10">
                            <div className="bg-white dark:bg-slate-900 p-5 rounded-[14px] flex justify-between items-center">
                                <div className="flex flex-col">
                                    <span className="font-bold text-gray-400 dark:text-slate-500 text-[10px] uppercase tracking-widest">الإجمالي النهائي</span>
                                    <span className="text-[10px] text-green-500 font-bold">{invoice.payment_method === 'cash' ? 'مدفوع نقداً' : 'آجل / ذمم'}</span>
                                </div>
                                <span dir="ltr" className="font-bold text-2xl text-gray-800 dark:text-white font-mono">{formatCurrency(invoice.total_amount)}</span>
                            </div>
                        </div>
                    </div>
                </div>
