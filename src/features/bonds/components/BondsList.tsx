...
const BondsList: React.FC<Props> = ({ bonds, isLoading, searchTerm }) => {
    ...
    if (isLoading) {
        return (
            <div className="p-20 text-center font-bold text-[10px] text-gray-400 uppercase animate-pulse">
                جاري تحميل السندات...
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col divide-y-0 gap-1 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <MicroListItem
                    ...
                    actions={
                        <div className="flex flex-col items-end gap-1">
                            <span dir="ltr" className={cn("text-sm font-bold font-mono leading-none", bond.type === 'receipt' ? "text-emerald-600" : "text-rose-600")}>
            ...
            {filteredBonds?.length === 0 && (
                <div className="p-20 text-center text-gray-300 font-bold uppercase text-[10px] tracking-widest border-2 border-dashed dark:border-slate-800 mt-4">
