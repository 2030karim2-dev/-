...
import { Brain, Calculator, Shield, RefreshCw, Clock } from 'lucide-react';
                ...
                actions={
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-1 bg-emerald-50 dark:bg-emerald-950/30 rounded-lg">
                            ...
                            <span className="text-[9px] font-bold text-emerald-600 dark:text-emerald-400">متصل</span>
                        </div>
                        <button
                            onClick={() => refetch()}
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 p-4 shadow-sm">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-sm font-bold text-gray-800 dark:text-white">{getGreeting()}</h2>
                        ...
                        <div className="flex items-center gap-3">
                            <div className="text-left">
                                <p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest">صحة الأعمال</p>
                                <p className={`text-xl font-bold font-mono ${healthScore >= 70 ? 'text-emerald-600' : healthScore >= 40 ? 'text-amber-500' : 'text-rose-500'}`}>
                    ...
                    {TABS.map(tab => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold transition-all duration-200 whitespace-nowrap ${isActive
