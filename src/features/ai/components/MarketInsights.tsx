        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-black text-gray-800 dark:text-white">تحليل السوق</h3>
            ...
            {result ? (
                <div className="space-y-3">
                    {result.insights.length > 0 && (
                        <div>
                            <p className="text-[9px] font-black text-gray-400 uppercase mb-1.5">📊 الملاحظات</p>
                    ...
                    {result.opportunities.length > 0 && (
                        <div>
                            <p className="text-[9px] font-black text-emerald-600 uppercase mb-1.5">🚀 الفرص</p>
                    ...
                    {result.threats.length > 0 && (
                        <div>
                            <p className="text-[9px] font-black text-rose-600 uppercase mb-1.5">⚠️ التهديدات</p>
