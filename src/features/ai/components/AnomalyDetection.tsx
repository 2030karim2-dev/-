        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border dark:border-slate-800 p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-gray-800 dark:text-white">كشف الشذوذ</h3>
                ...
                <button
                    ...
                    className="px-3 py-1.5 text-[10px] font-bold bg-rose-600 hover:bg-rose-500 disabled:bg-gray-300 text-white rounded-xl transition-all"
                >
                        ...
                        {result.anomalies.map((a, i) => (
                            <div key={i} className="bg-gray-50 dark:bg-slate-800/50 rounded-xl p-3 text-xs space-y-1">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold ${sevColors[a.severity] || sevColors['منخفض']}`}>{a.severity}</span>
                                </div>
