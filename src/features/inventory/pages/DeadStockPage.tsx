        ...
        <div className="h-full flex flex-col space-y-4 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border dark:border-slate-800 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t('dead_stock_analysis')}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border dark:border-slate-800 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold text-gray-900 dark:text-white">{formatCurrency(totalDeadStockValue)}</p>
                    </div>
                </div>
                <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border dark:border-slate-800 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold text-gray-900 dark:text-white">{formatNumberDisplay(totalDeadStockItems)}</p>
                    </div>
                </div>
                <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border dark:border-slate-800 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-bold text-gray-900 dark:text-white">{deadStock?.data?.length || 0}</p>
                    </div>
                </div>
            </div>
                ...
                {!deadStock?.data || deadStock.data.length === 0 ? (
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        <table className="w-full text-right">
                            <thead className="bg-gray-50 dark:bg-slate-800 sticky top-0 z-10 text-xs font-bold text-gray-500">
                                <tr>
