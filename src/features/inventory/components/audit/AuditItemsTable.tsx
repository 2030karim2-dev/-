    ...
    return (
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden">
            <table className="w-full text-right text-[10px]">
                <thead className="bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 font-bold border-b-2 border-gray-200 dark:border-slate-700 uppercase tracking-widest">
                    <tr>
                            ...
                            <tr key={field.id} className={cn(
                                ...
                                <td className="p-1 text-center">
                                    <input 
                                        ...
                                        className="w-full h-12 bg-gray-50 dark:bg-slate-800 border-2 border-gray-200 dark:border-slate-700 rounded-lg text-center font-mono font-bold text-xl text-gray-800 dark:text-slate-100 outline-none focus:border-blue-500 focus:bg-white"
