...
import {  ArrowLeftRight,  Search, Plus, Trash2,   FileText } from 'lucide-react';
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-gray-50 dark:bg-slate-800/50 rounded-xl border dark:border-slate-800 relative">
                    <div className="space-y-1">
                        <label className="text-[9px] font-bold text-gray-400 uppercase mr-1">من مستودع</label>
                        <select
                            value={fromWh}
                    ...
                    <div className="space-y-1">
                        <label className="text-[9px] font-bold text-gray-400 uppercase mr-1">إلى مستودع</label>
                        <select
                            value={toWh}
                ...
                {/* Selected Items List */}
                <div className="space-y-2">
                    <h3 className="text-[9px] font-bold text-gray-400 uppercase mr-1 tracking-widest">الأصناف المحددة</h3>
