            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        <label className="text-[9px] font-bold text-gray-400 uppercase mr-1">اسم جلسة الجرد</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1">
                        <label className="text-[9px] font-bold text-gray-400 uppercase mr-1">المستودع المستهدف</label>
                    ...
                    <div className="space-y-1">
                        <label className="text-[9px] font-bold text-gray-400 uppercase mr-1">نطاق الجرد</label>
                        <div className="flex bg-gray-100 dark:bg-slate-800 p-1 rounded-lg">
                            <button
                                onClick={() => setFormData({ ...formData, category: 'all' })}
                                className={`flex-1 py-1.5 rounded-md text-[9px] font-bold ${formData.category === 'all' ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-sm' : 'text-gray-400'}`}
                            >كافة الأصناف</button>
                            <button
                                onClick={() => setFormData({ ...formData, category: 'partial' })}
                                className={`flex-1 py-1.5 rounded-md text-[9px] font-bold ${formData.category === 'partial' ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-sm' : 'text-gray-400'}`}
                            >أصناف مختارة</button>
                        </div>
                    </div>
                </div>
